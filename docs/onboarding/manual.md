...
This page covers the same ground as the agent-assisted onboarding, written for humans reading directly. If you are using an AI-assisted editor (Cursor, Claude Code, GitHub Copilot), say "onboard me" in chat instead. The agent will walk you through these topics interactively.
