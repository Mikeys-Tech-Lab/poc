...
**Want to understand how the workspace learns from non-trivial work?** Read [Trace Climb](trace-climb.md). That topic explains trigger levels, durable artifacts, and how learning becomes visible in PRs.
...
6. **[Trace Climb](trace-climb.md)** — how non-trivial work becomes durable learning, when to preserve an `Evolution Record`, and when a short skip trace is enough.
...
| `docs/guidance/trace-climb.md` | Durable learning flow for non-trivial work. |
