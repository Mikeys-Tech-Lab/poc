...
<ActivationPrompts intro="If you want to move from the system map into live use, start with the seeder. These prompts preserve the boundary between reading and operation while giving you a direct runtime entry." />
